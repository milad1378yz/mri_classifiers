...
random.seed(0)
for filename in os.listdir("/scratch/st-sdena-1/miladyz/mri_classifiers/data/generated"):
    print(filename)
    data_dir = '/scratch/st-sdena-1/miladyz/mri_classifiers/data/Alzheimer_MRI_4_classes_dataset/'+filename
